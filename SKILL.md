...
Based on Glen Allsopp's Superpixels framework: small, intentional design choices that
are so specific and thoughtful that visitors feel the craft behind them. The goal is to
take what is standard and make it less so — to use every opportunity at your disposal
to create something unique and memorable, so your site sticks in minds when competing
against thousands of other brands in the same niche.
...
Trust elements that go beyond generic logo bars and "as seen on" sections.
...
Micro-interactions that reward curiosity and make browsing feel alive.
...
### 4. Personal Touches — Details that show humans behind the brand
...
Navigation elements that adapt, convert, or delight instead of just linking.
...
| Double navigation | Different navigation bars on different page types — homepage nav vs article nav vs review nav | Remodelista changes navigation twice as you scroll; TIME and Chron show different nav on homepage vs articles |
| Sticky affiliate nav | Affiliate link stays fixed in header until next product section | SiteBuilderReport keeps the current affiliate link pinned as you scroll through the review |
| Niche-relevant scroll-to-top | Custom scroll-to-top buttons themed to your industry | A drone site using a drone icon; an elevator for a real estate site; a rocket for a startup |
...
### 6. SuperHooks — Copy that reads the visitor's mind
...
### 7. Micro-Copy Personality — Words in unexpected places
...
### 8. Visual Craft — Tiny details showing obsessive attention

Pixel-level details that show someone cared about every element on the screen.
...
| Custom author presentation | Author avatars and bios designed to match the site aesthetic instead of being mismatched photos | Puck uses custom-designed author avatars |
| Custom niche icons | Per-section or per-FAQ icons that match the specific content, not generic shapes | BearFootTheory uses custom icons throughout that perfectly align to each section |
...
| Clean information-dense headers | Article headers packed with useful data (author, date, read time, update date) but still feeling clean and modern | BusinessNewsDaily achieves information density without overwhelming |
| Article-integrated commerce | Blend editorial content and product listings so you move between reading and shopping | BusinessInsider blends articles and eCommerce listings seamlessly |

### 9. Branded Content Areas — Give your content section its own identity
...
## Design & Usability Missed Opportunities
...
- **What is the page trying to accomplish?** (convert, inform, build trust, retain)
- **Who is the audience?** (their sophistication, expectations, pain points, what they're likely thinking)
- **What is the brand tone?** (warm, technical, playful, premium, clinical)
- **What already exists?** Read the current component code, design system, and any existing remarkable elements
- **What are visitors likely thinking or expecting?** (this is the key to SuperHooks)
...
### Step 2: Audit for Missed Opportunities
...
### Step 3: Propose 3-5 Superpixel Ideas

For each idea, provide:
- **Name** — A short descriptive name
- **Category** — Which Superpixel category it draws from
- **Inspired by** — The specific real-world example
...
- [ ] Standalone — can be dropped into any page without dependencies
- [ ] Personal to the brand — adapted to the specific tone, audience, and niche
- [ ] Not overdone — one great Superpixel per section is better than three mediocre ones

### Step 5: Verify

Screenshot the Superpixel at mobile and desktop viewports. Take zoomed screenshots
of the specific element, not full-page shots — detail matters for Superpixels.
...
- **Not generic "nice-to-haves."** Rounded cards, gradient backgrounds, and hover shadows are baseline design, not Superpixels.
- **Not complex for complexity's sake.** The best Superpixels are often surprisingly simple. A 30-second CSS change can be more remarkable than a 500-line JS animation.
- **Not AI slop.** No purple gradients, no glass morphism for its own sake, no "floating particles" backgrounds, no generic icon grids in colored circles.
- **Not borrowed wholesale.** Adapt ideas to the brand and context. A crypto site's open metrics dashboard concept becomes a counselor vetting pipeline for a spiritual care brand.
- **Not overdone.** You can go too far. If every element is trying to be clever, nothing feels clever. Stripe.com is pixel-perfect everywhere but never feels like it's trying too hard. That's the target.
- **Not one-size-fits-all.** Every Superpixel must be personal to the brand. A playful theme name Easter egg is perfect for an indie developer's blog but wrong for a healthcare company.
